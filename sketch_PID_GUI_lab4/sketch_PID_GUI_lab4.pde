...
//unma messing stuff up
float[] xrVals={0,-0.2,0.4,-0.4,0.2};
float[] yrVals={-0.4,0,-0.2,-0.2,0};
...
public void SimulationThread() {
  while (1==1) {
    ...
    if (haplyBoard.data_available()) {
      ...
      //code for the movement path
      //currentMillis = millis();
      //if (currentMillis - previousMillis > interval) {
      //  j=0;
      //  //code for movement along a star shape
      //  if(i!=4) {
      //    xr=xrVals[i];
      //    yr=yrVals[i];
      //  }
      ...
      //  }
        ...
        //i = 0;
        //}
        //code for movement along an infinity sign shape
        //if (i ==1) {
        //  xr = 0;
        //  yr = 0;
        //} else if (i ==2) {
